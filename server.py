...
# - Receives env updates, item selection, and user utterances from Unity
# - Logs turns and item info via logger.py
# - Calls agent.py to generate agent replies
# - Starts emotion_engine.py for face / emotion analysis
...
face_process = None          # Subprocess for emotion_engine.py
dialogue_concession = 0.0    # Percentage-based concession from dialogue length
